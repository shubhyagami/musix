...
## Overview
musix delivers a lightweight Java audio engine that streams music with minimal latency and supports real‑time collaborative playlists. It works as a standalone application and can be embedded in larger Java projects.
...
```
Open your browser at `http://localhost:8080` to view the UI.
