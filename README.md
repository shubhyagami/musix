...
## Overview  
musix is a small, fast Java audio engine that streams tracks with minimal latency and supports real‑time collaborative playlists. It can run as a standalone application or be embedded in other Java projects.
